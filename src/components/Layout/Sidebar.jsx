...
const Sidebar = () => {
  ...
  const matchesCount = stats?.matches?.total || 0;

  const navItems = [
    { icon: <FaHeart />, text: 'Dashboard', path: '/dashboard' },
    { icon: <FaSearch />, text: 'Discover', path: '/discover' },
    { icon: <FaComments />, text: 'Messages', path: '/messages', badge: unreadMessages },
    { icon: <FaUsers />, text: 'Matches', path: '/matches', badge: matchesCount },
    ...(meetsTierRequirement('Premium') ? [{ icon: <FaHeart />, text: 'Likes You', path: '/likes-you' }] : []),
  ...
  return (
    <div className="w-64 md:w-64 bg-white h-full shadow-lg flex flex-col min-h-screen">
