...
import { FaSearch, FaBell, FaEnvelope, FaMoneyBillWave, FaSignOutAlt, FaBars } from 'react-icons/fa';
...
const Navbar = ({ onSidebarToggle = () => {} }) => {
  ...
  return (
    <div className="bg-white shadow-sm py-4 px-4 md:px-6 flex items-center justify-between">
      {/* Mobile hamburger */}
      <button
      ...
      <h2 className="text-2xl font-bold text-[var(--dark)] flex-1">Dashboard</h2>
